...
.. code-block: gherkin
    ...
    Then the command output should not contain the following log records:
        | category | level   | message |
        | bar      | CURRENT | xxx     |
    Then the file "beehive.log" should contain the log records:
        | category | level   | message |
        | bar      | CURRENT | xxx     |
    Then the file "beehive.log" should not contain the log records:
        | category | level   | message |
        | bar      | CURRENT | xxx     |
...
from beehive.configuration import LogLevel
...
class LogRecordTable(object):
    ...
    def annotate_with_row_schema(table, row_schema):
        ...
        :param table:   Table w/ log-records (as :class:`beehive.model.Table`)
