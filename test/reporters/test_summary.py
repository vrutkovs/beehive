...
from beehive.model import ScenarioOutline, Scenario
from beehive.reporter.summary import SummaryReporter, format_summary
...
class TestSummaryReporter(object):
    ...
    @patch('sys.stdout')
    @patch('beehive.reporter.summary.format_summary')
