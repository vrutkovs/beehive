...
Feature: Issue #162 Unnecessary ContextMaskWarnings when assert fails or exception is raised
  ...
  | REASON: Context "beehive" mode is not restored when an exception is raised.
    ...
    Given a file named "features/example0162_assert_fails.feature" with:
      ...
      Feature:
        ...
        Scenario:
          Given a step passes
      """
    When I run "beehive -f plain features/example0162_assert_fails.feature"
    ...
    Given a file named "features/example0162_exception_raised.feature" with:
      ...
      Feature:
        ...
        Scenario:
          Given a step passes
      """
    When I run "beehive -f plain features/example0162_exception_raised.feature"
    Then it should fail with:
      """
      1 scenario passed, 1 failed, 0 skipped
      2 steps passed, 1 failed, 1 skipped, 0 undefined
