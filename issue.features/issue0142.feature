    ...
    And a file named "features/issue0142_example.feature" with:
        ...
        Feature:
            Scenario: Use a table
             Then use table data with:
                 | data                             | value |
                 | beehive outputs junit with tables | false |
        """
    When I run "beehive --junit -f json features/issue0142_example.feature"
    Then it should pass
    But the command output should not contain:
        """
        TypeError: <Row [u'beehive outputs junit with tables', u'false']> is not JSON serializable
        """
