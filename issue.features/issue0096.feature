...
Feature: Issue #96: Sub-steps failed without any error info to help debug issue
    ...
    | from beehive has no details whatsoever. It is virtually impossible
    ...
    |       ''')
    |
    | File ".../beehive/runner.py", line 262, in execute_steps
        ...
        Feature:
            Scenario:
                When the following steps should pass:
                   ...
                   """
        '''
    When I run "beehive -c features/issue96_case1.feature"
        ...
        Feature:
            Scenario:
                When the following steps should pass:
                   ...
                   """
        '''
    When I run "beehive -c features/issue96_case2.feature"
    Then it should fail with:
        """
        ...
        Feature:
            Scenario:
                When the following steps should pass:
                   ...
                   """
        '''
    When I run "beehive -c features/issue96_case3.feature"
    Then it should fail with:
        """
        ...
        Feature:
            Scenario:
                When the following steps should pass:
                   ...
                   """
        '''
    When I run "beehive -c features/issue96_case4.feature"
    Then it should fail with:
        """
  ...
  Scenario: Execute steps and fail in before_scenario hook
    ...
    And a file named "features/environment.py" with:
        ...
        def before_scenario(context, scenario):
            ...
            ''')
        """
    When I run "beehive -c features/issue96_case5.feature"
    Then it should fail with:
        """
