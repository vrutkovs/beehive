...
Feature: Runner should support a --dry-run option
    ...
    As a tester
    I want to check if beehive tests are syntactically correct
    ...
    Scenario: Dry-run one feature should mark feature/scenarios/steps as untested
        When I run "beehive -f plain --dry-run features/alice.feature"
    ...
    Scenario: Dry-run one feature with tags should mark skipped scenario/steps as skipped
        When I run "beehive -f plain --dry-run --tags=@selected --no-skipped features/alice.feature"
        Then it should pass with:
            """
            0 features passed, 0 failed, 0 skipped, 1 untested
    ...
    Scenario: Dry-run two features
        When I run "beehive --dry-run features/alice.feature features/bob.feature"
        Then it should pass with:
            """
    ...
    Scenario: Dry-run one feature with undefined steps
        When I run "beehive --dry-run features/undefined_steps.feature"
    ...
    Scenario: Dry-run two features, one with undefined steps
        When I run "beehive --dry-run features/alice.feature features/undefined_steps.feature"
        Then it should fail with:
            """
            0 features passed, 0 failed, 0 skipped, 2 untested
            0 scenarios passed, 0 failed, 0 skipped, 6 untested
    ...
    Scenario: Dry-run two features, one with undefined steps and use tags
        When I run "beehive --dry-run --tags=@selected features/alice.feature features/undefined_steps.feature"
        Then it should fail with:
            """
            0 features passed, 0 failed, 0 skipped, 2 untested
    ...
    Scenario: Dry-run two features, one with undefined steps and use other tags
        When I run "beehive --dry-run --tags=@other_selected features/alice.feature features/undefined_steps.feature"
        Then it should fail with:
            """
            0 features passed, 0 failed, 0 skipped, 2 untested
