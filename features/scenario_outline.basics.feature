...
Feature: Issue #187 ScenarioOutline uses wrong return value when if fails
  ...
  Ensure that ScenarioOutline run-logic beehives as expected.
  ...
  Scenario: All examples pass
    Given a file named "features/example.scenario_outline_pass.feature" with:
      ...
      """
    When I run "beehive -f plain features/example.scenario_outline_pass.feature"
      ...
      Feature:  First Example in Scenario Outline fails
        Scenario Outline:
          ...
          Examples:
            ...
            | passes  | Last  example passes |
      """
    When I run "beehive -f plain features/example.scenario_outline_fail_first.feature"
  ...
  Scenario: Last example fails
    Given a file named "features/example.scenario_outline_fail_last.feature" with:
      ...
      """
    When I run "beehive -f plain features/example.scenario_outline_fail_last.feature"
    Then it should fail with:
      """
      0 features passed, 1 failed, 0 skipped
      1 scenario passed, 1 failed, 0 skipped
      ...
      Feature:  Middle Example in Scenario Outline fails
        Scenario Outline:
          ...
          Examples:
            ...
            | passes  | Last   example passes |
      """
    When I run "beehive -f plain features/example.scenario_outline_fail_middle.feature"
    Then it should fail with:
      """
      0 features passed, 1 failed, 0 skipped
