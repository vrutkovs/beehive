Feature: Undefined Step
    ...
    Scenario: An undefined step should be reported
      When I run "beehive -f plain -T features/undefined_last_step.feature"
      Then it should fail
    ...
    Scenario: An undefined step should cause its scenario to fail
      When I run "beehive -f plain features/undefined_last_step.feature"
      ...
      Given a file named "features/undefined_step_and_more.feature" with:
        ...
        Feature:
          Scenario:
            ...
            And  a step fails
        """
      When I run "beehive -f plain -T features/undefined_step_and_more.feature"
      Then it should fail with:
        """
        0 features passed, 1 failed, 0 skipped
        0 scenarios passed, 1 failed, 0 skipped
    ...
    Scenario: Two undefined steps in same scenario should be detected
      Given a file named "features/two_undefined_steps1.feature" with:
        ...
        """
      When I run "beehive -f plain -T features/two_undefined_steps1.feature"
      Then it should fail with:
        """
        0 features passed, 1 failed, 0 skipped
        0 scenarios passed, 1 failed, 0 skipped
      ...
      Given a file named "features/two_undefined_steps2.feature" with:
        ...
        Feature:
          ...
          Scenario:
            ...
            When a step passes
        """
      When I run "beehive -f plain -T features/two_undefined_steps2.feature"
      Then it should fail with:
        """
        0 features passed, 1 failed, 0 skipped
      ...
      Given a file named "features/undefined_step_in_scenario_outline.feature" with:
        ...
        Feature:
          ...
          Examples:
            ...
            |  fails   | fails    |
        """
      When I run "beehive -f plain -T features/undefined_step_in_scenario_outline.feature"
      Then it should fail with:
        """
        0 features passed, 1 failed, 0 skipped
      ...
      Given a file named "features/two_undefined_step_in_scenario_outline.feature" with:
        ...
        Feature:
          ...
          Examples:
            ...
            |  fails   | fails    |
        """
      When I run "beehive -f plain features/two_undefined_step_in_scenario_outline.feature"
      Then it should fail with:
        """
        0 features passed, 1 failed, 0 skipped
        0 scenarios passed, 4 failed, 0 skipped
      ...
      Given a file named "features/undefined_steps_with_tagged_scenario.feature" with:
        ...
        Feature:
          ...
          Scenario: S3
            ...
            Then a step fails
        """
      When I run "beehive -f plain --tags=@selected features/undefined_steps_with_tagged_scenario.feature"
      Then it should fail with:
        """
        0 features passed, 1 failed, 0 skipped
    ...
    Scenario: Undefined steps are detected if --dry-run option is used
      When I run "beehive -f plain --dry-run features/undefined_steps_with_tagged_scenario.feature"
      Then it should fail with:
        """
