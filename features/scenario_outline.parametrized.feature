Feature: Scenario Outline -- Parametrized Scenarios
  ...
  Scenario: Test Setup
    ...
    And a file named "beehive.ini" with:
      """
      [beehive]
      ...
      Feature: SOP1
        Scenario Outline: Use placeholder <name>-<param1>
          ...
          Examples: E-<ID>
            ...
            | 002 | Bob   |  101  |
      """
    When I run "beehive -f progress3 features/use_name_with_row_params.feature"
      ...
      Feature: SOP2
        Scenario Outline: Use placeholder S<examples.index>-<row.index> <examples.name>
          ...
          Examples: E-<ID>/@<row.id>
            ...
            | 002 | Bob   |  101  |
      """
    When I run "beehive -f progress3 features/use_name_with_special_params.feature"
    Then it should pass with:
      """
      ...
      Feature:
        Scenario Outline: Use row placeholders
          ...
          Examples:
            ...
            | 002 | Bob   |  102   |
      """
    When I run "beehive -f plain --no-timings features/use_steps_with_params.feature"
    Then it should pass with:
      """
      Scenario Outline: Use row placeholders -*-
      ...
      Feature:
        Scenario Outline: Use unknown placeholders
          ...
          Examples:
            ...
            | 001 | Alice |  100   |
      """
    When I run "beehive -f plain --no-timings features/use_steps_with_unknown_params.feature"
    Then it should pass with:
      """
      Scenario Outline: Use unknown placeholders -*-
  ...
  Scenario: Use placeholders in generated scenario step.text
    Given a file named "features/use_steps_with_param_text.feature" with:
      ...
      '''
    When I run "beehive -f plain --no-timings features/use_steps_with_param_text.feature"
    Then it should pass with:
      '''
      Scenario Outline: Use parametrized step with text -*-
      ...
      Feature:
        Scenario Outline: Use parametrized step with table
          ...
          Examples:
            ...
            | 001 | Alice |  Hello   | Pony express  |
      """
    When I run "beehive -f plain --no-timings features/use_steps_with_param_table.feature"
    Then it should pass with:
      """
      Scenario Outline: Use parametrized step with table -*- 
      ...
      Feature:
        Scenario Outline: Use special placeholders @<row.id>
          ...
          Examples: E-<ID>/@<row.id>
            ...
            | 002 | Bob   |  101  |
      """
    When I run "beehive -f plain --no-timings features/use_steps_with_special_params.feature"
    Then it should pass with:
      """
  ...
  Scenario: When special placeholder name is used for row data (Case: Override)
    ...
    Given a file named "beehive.ini" with:
      """
      [beehive]
      ...
      Feature: SOP3
        Scenario Outline: Use placeholder data:row.id=<row.id>
          ...
          Examples: E-<ID>/<row.id>
            ...
            | 002 | Bob   |  101  |
      """
    When I run "beehive -f progress3 features/use_name_with_overwritten_params.feature"
    Then it should pass with:
      """
      Use placeholder data:row.id=100 -*- special:row.id=@1.1 E-001/100  ..
      Use placeholder data:row.id=101 -*- special:row.id=@1.2 E-002/101  ..
      """
    When I run "beehive -f plain --no-timings features/use_name_with_overwritten_params.feature"
    Then it should pass with:
      """
  ...
  Scenario: Placeholder value has placeholder syntax (Case: recursion-check)
    ...
    And a file named "features/use_value_with_placeholder_syntax.feature" with:
      ...
      """
    When I run "beehive -f plain --no-timings features/use_value_with_placeholder_syntax.feature"
    Then it should pass with:
      """
      ...
      Feature:
        ...
        Scenario Outline: Use parametrized tags
          ...
          Examples:
            ...
            | 002 | Bob   |
      """
    When I run "beehive -f pretty -c --no-timings features/parametrized_tags.feature"
    Then it should pass with:
      """
  ...
  Scenario: Parametrized tags in a Scenario Outline (Case: Whitespace... in value)
    ...
    And a file named "features/parametrized_tags2.feature" with:
      ...
      """
    When I run "beehive -f pretty -c --no-source features/parametrized_tags2.feature"
    Then it should pass with:
      """
