Feature: Scenario Description
    ...
    Scenario: First Example for a Scenario Description
      Given a file named "features/example_description1.feature" with:
        ...
        """
      When I run "beehive -f plain -T features/example_description1.feature"
    ...
    Scenario: Inspect the Scenario Description by using JSON
      ...
      When I run "beehive -f json.pretty -o example1.json -f plain -T features/example_description1.feature"
      Then it should pass
        ...
        Feature: F2
          ...
          Scenario: S2.2
            ...
            Scenario description line S2.2-1.
                ...
                When a step passes with "Bob"
        """
      When I run "beehive -f json.pretty -o example2.json -f plain -T features/example_description2.feature"
      Then it should pass with:
        """
        1 feature passed, 0 failed, 0 skipped
