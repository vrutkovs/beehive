@sequential
Feature: Default paths for features in beehive configfile
    ...
    (and to support my laziness while using beehive in a shell).
    ...
    Scenario: Used default paths from beehive configfile
        When I run "beehive -f plain"
    ...
    Scenario: Command-line args can override default paths in configfile
        When I run "beehive -f plain features/alice.feature"
        Then it should pass with:
            """
